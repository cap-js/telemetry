...
// logger is wired to cds.log — recurses back through cds.log.format into an unbounded loop.
...
module.exports = resource => {
  ...
  cds.on('served', () => {
    ...
    // logger.emit() and looping through the logs SDK's export/diagnostic output.
    let emitting = false
