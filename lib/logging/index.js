...
module.exports = resource => {
   ...
   * In ZTI flow, 'served' may have already fired, so we also call immediately.
   */
  ...
  // Register for 'served' event (normal flow) and also call immediately (ZTI flow where 'served' already fired)
