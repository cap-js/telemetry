...
function initTenantQueueStatistics(statistics, tenant, queuedServiceName) {
  ...
  // TODO: move to async addBatchObservableCallback
...
module.exports = () => {
  ...
  cds.on('listening', () => {
    ...
    cds.db.after(['CREATE'], queueEntity, async (_, req) => {
      ...
      const queuedServiceName = JSON.parse(req.data.msg).service ?? req.data.target
      ...
      // TODO: clear tenant after timeout of inactivity?
