...
function getExporters() {
  ...
  const tracingExporterModule =
    tracing.module === '@cap-js/opentelemetry-instrumentation' ? require('./exporter') : _require(tracing.module)
  ...
  const metricsExporterModule =
    tracing.module === '@cap-js/opentelemetry-instrumentation' ? require('./exporter') : _require(metrics.module)
