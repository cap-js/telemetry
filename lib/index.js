...
const { diag, trace, metrics: metric } = require('@opentelemetry/api')
...
module.exports = function () {
  ...
  const mp = metric.getMeterProvider()

  LOG.info(`tracerProvider:`, tracerProvider)
  LOG.info(`tracerProvider === tp:`, tracerProvider === tp)
  LOG.info(`meterProvider:`, meterProvider)
  LOG.info(`meterProvider === mp:`, meterProvider === mp)
