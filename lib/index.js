...
function setup_standalone() {
  ...
  // Single code path for all scenarios including CaaS with ZTI.
  // For CaaS, the exporters use LazyExporter which buffers telemetry
  // until mTLS credentials become available.
