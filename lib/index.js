...
const { getInstrumentations, getResource, getSampler, getPropagator, getExporters } = require('./config')
...
module.exports = function () {
  ...
  if (process.env.NODE_ENV !== 'production' || !isDynatraceEnabled()) setSpanProcessor(tracerProvider, exporters.tracing)
