...
// One-shot startup provisioning: if ZTI is the active cert source (enabled + bound), load the
// initial SVID into cds.env and start watching for rotations. Returns whether ZTI is active —
// independent of whether certs are present yet, since they may arrive asynchronously.
function setup() {
