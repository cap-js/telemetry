...
function getCredsForCLSAsUPS() {
  ...
  // to support connection via user-provided services, the instance must have a tag "cloud-logging" or "Cloud Logging"
  ...
  if (ups) {
    // prettier-ignore
    LOG._warn && LOG.warn('User-provided service instances of SAP Cloud Logging should have tag "cloud-logging" or "Cloud Logging"')
