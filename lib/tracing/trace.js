...
module.exports = function trace(name, fn, targetObj, args, options = {}) {
  ...
  // REVISIT: calculate this only once
  ...
  if (targetObj.dbc) {
    ...
    if (typeof name === 'string') {
      ...
      attributeMap.set(SemanticAttributes.DB_STATEMENT, sql[1])
      attributeMap.set(SemanticAttributes.DB_OPERATION, sql[1].match(/\w+/)[0])
    }
  }
