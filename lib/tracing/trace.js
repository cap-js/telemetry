  ...
  if (targetObj.dbc || options.sql) {
    ...
    if (targetObj.dbc?.constructor.name in { HDBDriver: 1, HANAClientDriver: 1 }) {
      ...
      let passport = [
        ...
        /* ACTIONTYPE      */ '0000',
        /* PREVCOMPONENTID */ spanId.toUpperCase() + '202020202020202020202020202020202020202020202020',          // or sappp.previousComponentName
        /* TRANSACTIONID   */ Buffer.from(traceId.toUpperCase()).toString('hex'),
        /* CLIENT          */ '202020',
        /* COMPONENTTYPE   */ '0000',
        /* ROOTCONTEXTID   */ traceId.toUpperCase(),                                                              // or sappp.rootContextID
        /* CONNECTIONID    */ '0000000000000001' + spanId.toUpperCase(),                                          // or sappp.connectionID + spanId
        /* CONNECTIONCNT   */ '00000001',                                                                         // or sappp.connectionCounter
        /* VARPARTCOUNT    */ '0000',
        /* VARPARTOFFSET   */ '0226',
        /* EYECATCHER      */ '2A54482A'
      ]
      passport = passport.join('')
      passport = passport.replace('LLLL', passport.length.toString().padStart(4, '0'))
      LOG.debug('Setting SAP Passport:', passport)
