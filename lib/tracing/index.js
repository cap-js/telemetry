...
const { isDynatraceEnabled, _require } = require('../utils')
...
function _getExporter() {
  ...
  const tracingExporterModule =
    tracingExporter.module === '@cap-js/opentelemetry-instrumentation'
      ? require('../exporter')
      : _require(tracingExporter.module)
  ...
  const exporter = new tracingExporterModule[tracingExporter.class]({ ...(tracingExporter.config || {}) })
...
module.exports = resource => {
   ...
   */
  // REVISIT: individualize per component?
